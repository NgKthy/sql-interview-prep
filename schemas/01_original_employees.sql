-- ============================================================
-- 01_original_employees.sql
-- Schema gốc từ repo Aafreen29, đã chuẩn hóa
-- Hệ CSDL: MySQL 8.0+
-- ============================================================

DROP DATABASE IF EXISTS sql_interview_prep;
CREATE DATABASE sql_interview_prep CHARACTER SET utf8mb4;
...
-- ------------------------------------------------------------
-- Bảng user_name (dùng cho câu hỏi tách first name)
-- ------------------------------------------------------------
CREATE TABLE user_name (
    full_names CHAR(30)
);

INSERT INTO user_name (full_names) VALUES
    ('Jessica Taylor'),
    ('Erin Russell'),
    ('Amanda Smith'),
    ('Sam Brown'),
...
INSERT INTO messages_detail (user_id, messages_sent, date) VALUES
    (1, 120, '2014-04-27'), (2, 50, '2014-04-27'),  (3, 222, '2014-04-27'),
    (4, 70, '2014-04-27'),  (5, 250, '2014-04-27'), (6, 246, '2014-04-27'),
    (7, 179, '2014-04-27'), (8, 116, '2014-04-27'), (9, 84, '2014-04-27'),
    (10, 215, '2014-04-27'),(11, 105, '2014-04-27'),(12, 174, '2014-04-27'),
    (13, 158, '2014-04-27'),(14, 30, '2014-04-27'), (15, 48, '2014-04-27');
...
INSERT INTO DIALOGLOG (user_id, app_id, type, date) VALUES
...
-- ------------------------------------------------------------
-- Bảng event_session_details & user_details
-- ------------------------------------------------------------
...
INSERT INTO user_details (date, session_id, user_id) VALUES
    ('2019-01-10', 201, 6), ('2019-01-10', 202, 7), ('2019-01-10', 203, 6),
    ('2019-01-11', 204, 8), ('2019-01-10', 205, 6), ('2019-01-11', 206, 8),
    ('2019-01-12', 207, 9);

INSERT INTO event_session_details (date, session_id, timespend_sec, user_id) VALUES
    ('2019-01-10', 201, 1200, 6), ('2019-01-10', 202, 100, 7),
    ('2019-01-10', 203, 1500, 6), ('2019-01-11', 204, 2000, 8),
    ('2019-01-10', 205, 1010, 6), ('2019-01-11', 206, 1780, 8),
    ('2019-01-12', 207, 2500, 9), ('2019-01-12', 208, 500, 9),
    ('2019-01-21', 209, 2798, 15),('2019-01-25', 210, 1278, 18);
...
INSERT INTO login_info (user_id, login_time) VALUES
    (1, '2017-08-10 14:32:25'), (2, '2017-08-11 14:32:25'),
    (3, '2017-08-11 14:32:25'), (2, '2017-08-13 14:32:25'),
    (3, '2017-08-14 14:32:25'), (4, '2017-08-15 14:32:25'),
    (5, '2017-08-12 14:32:25'), (2, '2017-08-18 14:32:25'),
    (1, '2017-08-11 14:32:25'), (1, '2017-08-12 14:32:25'),
    (1, '2017-08-13 14:32:25'), (1, '2017-08-14 14:32:25'),
    (1, '2017-08-15 14:32:25'), (1, '2017-08-16 14:32:25'),
    (1, '2017-08-17 14:32:25'), (3, '2017-08-20 14:32:25'),
    (5, '2017-08-16 14:32:25'), (2, '2017-08-21 14:32:25'),
    (3, '2017-08-22 14:32:25');

-- ------------------------------------------------------------
-- Bảng USER_ACTION (friend acceptance)
-- ------------------------------------------------------------
...
INSERT INTO USER_ACTION (user_id_who_sent, user_id_to_whom, date_action, action) VALUES
...
-- ------------------------------------------------------------
-- Bảng all_students & attendance_events
-- ------------------------------------------------------------
...
INSERT INTO all_students (student_id, school_id, grade_level, date_of_birth, hometown) VALUES
...
INSERT INTO attendance_events (date_event, student_id, attendance) VALUES
    ('2018-01-10', 110111, 'present'), ('2018-01-10', 110121, 'present'),
    ('2018-01-12', 110115, 'absent'),  ('2018-01-13', 110119, 'absent'),
    ('2018-01-13', 110121, 'present'), ('2018-01-14', 110125, 'present'),
    ('2018-02-05', 110111, 'absent'),  ('2018-02-17', 110115, 'present'),
...
INSERT INTO ad_accounts (account_id, date, account_status) VALUES
    (101, '2019-01-21', 'active'), (102, '2019-01-17', 'active'),
    (117, '2019-02-06', 'active'), (112, '2019-01-16', 'active'),
    (110, '2019-03-22', 'fraud'),  (115, '2019-04-28', 'fraud'),
    (103, '2019-02-07', 'close'),  (112, '2019-04-15', 'fraud'),
    (101, '2019-04-28', 'fraud'),  (117, '2019-04-22', 'fraud'),
    (102, '2019-03-19', 'fraud'),  (106, '2019-04-28', 'fraud'),
    (105, '2019-03-02', 'active'), (110, '2019-04-28', 'fraud');

-- ------------------------------------------------------------
-- Bảng friend_request & request_accepted
-- ------------------------------------------------------------
...
INSERT INTO friend_request (requestor_id, sent_to_id, time) VALUES
    (1, 2, '2018-06-03'), (1, 3, '2018-06-08'), (1, 3, '2018-06-08'),
    (2, 4, '2018-06-09'), (3, 4, '2018-06-11'), (3, 5, '2018-06-11'),
    (3, 5, '2018-06-12');
...
INSERT INTO request_accepted VALUES
    (2, 1, '2018-08-01'), (3, 1, '2018-08-01'), (3, 1, '2018-08-01'),
    (4, 2, '2018-08-02'), (5, 3, '2018-08-03'), (5, 3, '2018-08-03'),
    (5, 3, '2018-08-04');
...
INSERT INTO new_request_accepted (acceptor_id, requestor_id, accept_date) VALUES
    (2, 1, '2018-05-01'), (3, 1, '2018-05-02'), (4, 2, '2018-05-02'),
    (5, 3, '2018-05-03'), (3, 4, '2018-05-04');
...
INSERT INTO count_request (country_code, count_of_requests_sent, percent_of_request_sent_failed, sent_date) VALUES
    ('AU', 23676, '5.2%', '2018-09-07'), ('NZ', 12714, '2.1%', '2018-09-08'),
    ('IN', 24545, '4.6%', '2018-09-09'), ('IN', 34353, '5.3%', '2018-09-10'),
    ('AU', 24255, '1.7%', '2018-09-11'), ('NZ', 23131, '2.9%', '2018-09-12'),
    ('US', 49894, '5.3%', '2018-09-13'), ('IN', 19374, '2.4%', '2018-09-14'),
    ('AU', 18485, '2.7%', '2018-09-15'), ('IN', 38364, '3.5%', '2018-09-16');

-- ------------------------------------------------------------
-- Bảng confirmation_no (BUG gốc: bảng confirmed_no chưa tạo)
-- ------------------------------------------------------------
CREATE TABLE confirmation_no (
    phone_number CHAR(15)
);

INSERT INTO confirmation_no (phone_number) VALUES
    ('232-473-3433'), ('545-038-2294'), ('647-294-1837'),
    ('492-485-9727'), ('545-383-7837'), ('184-483-9575'),
    ('493-420-4902'), ('282-595-8373'), ('594-9594-2948');

CREATE TABLE confirmed_no (
    phone_number CHAR(15)
);

INSERT INTO confirmed_no (phone_number) VALUES
    ('492-485-9727'), ('545-383-7837'), ('184-483-9575'), ('493-420-4902');
...
INSERT INTO user_interaction (user_1, user_2, date) VALUES
    ('A', 'B', '2019-03-23'), ('A', 'C', '2019-03-23'),
    ('B', 'D', '2019-03-23'), ('B', 'F', '2019-03-23'),
    ('C', 'D', '2019-03-23'), ('A', 'D', '2019-03-23'),
    ('B', 'C', '2019-03-23'), ('A', 'E', '2019-03-23');

-- ------------------------------------------------------------
-- Bảng salesperson, customer, orders
-- ------------------------------------------------------------
...
INSERT INTO salesperson (id, name, age, salary) VALUES
    (1, 'Abe', 61, 140000), (2, 'Bob', 34, 44000),
...
INSERT INTO orders (number, order_date, cust_id, salesperson_id, amount) VALUES
    (10, '1996-02-08', 4, 2, 540), (20, '1999-01-30', 4, 8, 1800),
    (30, '1995-07-14', 9, 1, 460), (40, '1998-01-29', 7, 2, 2400),
    (50, '1998-02-03', 6, 7, 600), (60, '1998-03-02', 6, 7, 720),
